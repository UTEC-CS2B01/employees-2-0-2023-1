...
def create_app(test_config=None):
    ...
    @app.route('/employees', methods=['DELETE' , 'PATCH'])
    ...
    @app.route('/departments', methods=['DELETE' ,'PATCH'])
    def modify_departments(id):
    ...
    @app.route('/departments/<id>', methods=['GET','PATCH', 'DELETE'])
