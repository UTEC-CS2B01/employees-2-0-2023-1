...
class EmployeesTests(unittest.TestCase):
    ...
    def test_create_employee_success(self):
        ...
        self.client.delete("/employees/" + data["id"])
        self.client.delete("/departments/" + department_id)
    ...
    def test_create_department_from_employee_success(self):
        ...
        response = self.client.post('/employees/' + employee_id + '/departments',
                                    json={
                                        "name": "Servicio",
                                        "short_name": "ss"})
        data = json.loads(response.data)
    ...
    def test_create_department_from_employee_failed_500(self):
        ...
        response = self.client.post('/employees/' + employee_id + '/departments',
                                    json=self.invalid_new_department)
        data = json.loads(response.data)

        self.assertEqual(response.status_code, 500)
        self.assertEqual(data['success'], False)

        self.client.delete("/employees/" + employee_id)
        self.client.delete("/departments/" + department_id)
    ...
    def test_get_department_from_employee_success(self):
        ...
        response = self.client.get('/employees/' + employee_id + "/department")
        data = json.loads(response.data)
    ...
    def test_get_employee_from_department_success(self):
        response = self.client.post('/departments', json=self.new_department)
        data_department = json.loads(response.data)
        department_id = data_department['id']
        ...
        response = self.client.get('/departments/' + department_id + "/employees")
        data = json.loads(response.data)

        self.assertEqual(response.status_code, 200)
        self.assertEqual(data['success'], True)

    def test_get_employee_from_department_404(self):
    ...
    def test_delete_employee_success(self):
        ...
        response = self.client.delete("/departments/" + department_id)
    ...
    def test_change_department_success(self):
        ...
        response = self.client.patch('/departments/' + department_id, json={
    ...
    def test_change_employee_success(self):
        ...
        response = self.client.patch('/employees/' + employee_id, json={
            'firstname': 'James',
            'lastname': 'Bond',
            'age': 25,
        })
